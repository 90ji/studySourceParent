...
class ConstructorResolver {
     ...
     */
    public BeanWrapper autowireConstructor(final String beanName, final RootBeanDefinition mbd, Constructor<?>[] chosenCtors/*null*/, final Object[] explicitArgs/*null*/) {
        ...
        if (explicitArgs != null) {
            ...
            if (argsToResolve != null) {
                //解析参数类型,如给定方法的构造函数如给定方法的构造函数A(int,int)则通过此方法后就会把配置中的("1","1")转换为（1,1） 　 　 　
                //缓存中的值可能是原始值也肯能是最终值
        ...
        if (constructorToUse == null) {
            ...
            //排序给定的构造方法,public 构造方法优先参数数量降序,非public构造方法参数数量降序
    ...
    private ArgumentsHolder createArgumentArray(String beanName, RootBeanDefinition mbd, ConstructorArgumentValues resolvedValues, BeanWrapper bw, Class<?>[] paramTypes, String[] paramNames, Object methodOrCtor, boolean autowiring) throws UnsatisfiedDependencyException {
        ...
        for (int paramIndex = 0; paramIndex < paramTypes.length; paramIndex++) {
            ...
            ValueHolder valueHolder = resolvedValues.getArgumentValue(paramIndex, paramType, paramName, usedValueHolders);
            ...
            if (valueHolder != null) {
                ...
                if (valueHolder.isConverted()) {
                    ...
                    ValueHolder sourceHolder = (ValueHolder) valueHolder.getSource();
