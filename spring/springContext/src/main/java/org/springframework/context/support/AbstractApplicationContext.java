...
public abstract class AbstractApplicationContext extends DefaultResourceLoader implements ConfigurableApplicationContext, DisposableBean {
     ...
     */
    private Set<ApplicationEvent> earlyApplicationEvents;// new LinkedHashSet<ApplicationEvent>();
    ...
    public ConfigurableEnvironment getEnvironment() {
        ...
        return this.environment;//new StandardEnvironment()
    }
    ...
    public void refresh() throws BeansException, IllegalStateException {
        synchronized (this.startupShutdownMonitor) {
            ...
            try {
                ...
                //初始化应用消息广播器,并放入"applicationEnventMulitcaster"bean中
                ...
                //再所有注册debean中查找Listener bean,注册到消息广播器中
                registerListeners();
